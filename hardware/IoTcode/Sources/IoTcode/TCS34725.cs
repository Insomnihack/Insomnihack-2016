...

{
    ...
    class TCS34725
    {
        ...
        private KnownColor[] colorList = 
       {
            new KnownColor(Color.FromArgb(255, 0, 0, 0), "Black"),
            new KnownColor(Color.FromArgb(255, 255, 255, 255),"White"),
            new KnownColor(Color.FromArgb(255, 30, 90, 140), "Blue"),
            new KnownColor(Color.FromArgb(255, 150, 60, 60),"Red"),
            new KnownColor(Color.FromArgb(255, 0, 255, 0), "Green"),
            new KnownColor(Color.FromArgb(255, 100, 100, 40), "Yellow"),
            new KnownColor(Color.FromArgb(255, 140, 70, 40), "Orange")
        };
        ...
        public struct KnownColor
        {
            ...
            public KnownColor(Color value, string name)
            {
                ...
                Debug.WriteLine("Color {0} is R={1}, G={2}, B={3}", name, value.R, value.G, value.B); 
            }
        };
        ...
        eTCS34725Gain _tcs34725Gain = eTCS34725Gain.TCS34725_GAIN_4X;
